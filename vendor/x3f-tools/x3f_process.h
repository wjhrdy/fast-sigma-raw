...
typedef enum x3f_color_encoding_e {
  ...
  LINEAR_SRGB=6,	 /* Scene-linear sRGB, suitable for a LinearRaw DNG */
  LINEAR_BMT=7,	 /* Normalized, gain-corrected BMT calibration data */
  LINEAR_ROMM=8,	 /* Scene-linear Photo Pro ROMM working space */
